  ...
  return (
    <section>
      ...
      <p className="mt-3 max-w-2xl text-slate-400">
        Clientes, quadras e agenda estão disponíveis. Proprietários e gerentes
        também podem acompanhar o fluxo de caixa no financeiro.
      </p>
      <div className="mt-9 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        {(context.role === "OWNER" || context.role === "MANAGER") && (
          <div className="rounded-2xl border border-white/10 bg-slate-900 p-6">
            ...
            <p className="mt-3 text-xl font-semibold">Acompanhe o caixa</p>
            <Link
              href="/finance"
              className="mt-5 inline-block text-sm font-semibold text-lime-400 hover:underline"
            >
